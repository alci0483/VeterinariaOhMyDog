...
class PerrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perro" do
    assert_difference("Perro.count") do
      post perros_url, params: { perro: { edad: @perro.edad, estado_salud: @perro.estado_salud, nombre: @perro.nombre, raza: @perro.raza, sexo: @perro.sexo, user_id: @perro.user_id } }
    end
  ...
  test "should update perro" do
    patch perro_url(@perro), params: { perro: { edad: @perro.edad, estado_salud: @perro.estado_salud, nombre: @perro.nombre, raza: @perro.raza, sexo: @perro.sexo, user_id: @perro.user_id } }
